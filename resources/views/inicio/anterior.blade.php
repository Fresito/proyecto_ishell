...
<body>
       ...
       <p> 
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>Productos Gamer y más.</h3>
                <p>Accesorios, Juegos, etc.</p>
            </div>
   ...
   <section class="content price">
        ...
        <article class="contain">
            ...
            <h2 class="title">Tienda de Tecnología</h2>
   ...
   <section class="content contact">
        ...
        <div class="footer-section">
            ...
            <div>
                <p>54545754</p>
                <figure>
                    <img src="../img/estandar4.png" height="50%" width="50%" alt="mapa">
                </figure>
            </div>
